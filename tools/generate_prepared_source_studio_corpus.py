"""从正式 Python definitions 和 Presentation 生成 0.3.4 机器盘点。
...
def corpus_document() -> dict[str, Any]:
    ...
    return {
        "contract_kind": "studio_prepared_source_schema_authoring_corpus",
...
def main() -> None:
    ...
    if arguments.write:
        ...
        raise SystemExit(f"Generated prepared-source Studio asset differs: {CORPUS.name}")
