...
Phase 0 只完成架构权威切换。当前 React 应用仍是 `main@198d802` 的 0.1.0 legacy implementation：
...
- Phase 1–2 完成 Project Service、Graph Core、Scheduler 与 Node Runner 后，Phase 3 才会把 GUI-0 接入真实
  服务并删除双轨入口。
...
这些命令只证明权威切换没有破坏 legacy Studio，不代表 0.2.0 Project Service 或 Runtime 已经完成。
