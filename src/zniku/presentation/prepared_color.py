...
from zniku.source_color.definitions import definition_role as preparation_definition_role
...
PARAMETER_LABELS = {
    **OVERLAP_LABELS,
    ...
    "interpretation_policy": "本工程工作色彩解释",
...
PARAMETER_HELP = {
    **OVERLAP_HELP,
    ...
    "interpretation_policy": (
        "默认要求明确声明；仅用户主动确认时按 SDR BT.709/有限范围/left 解释缺失项。"
        "不是探测事实或色彩转换，不改原件与修复副本；显式冲突不能覆盖。"
    ),
